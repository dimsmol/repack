...
Repacker.prototype.getSrcKeys = function (dstKeys) {
	...
	if (this.othersRule != null) {
		this.othersRule.addDependsOnSrcKeys(arr, otherDstKeys);
	}
	return result;
};
...
Repacker.repacker = function (opt_rules, opt_othersRule) {
	var othersRule = opt_othersRule == undefined ? new FixKeys() : null;
	return new Repacker(opt_othersRule, othersRule);
};
